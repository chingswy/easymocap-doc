...
1. 在正对人的中间位置高低放置两个相机,最好保证正面的视角能够覆盖人的两只手,如果手的活动范围比较大,那么需要增加相机视野.
...
- 侧面的视角多录一些,特别是两侧的视角,一定要有能够共视的图像.拍左侧的相机的时候可以站在靠右侧的位置,离左侧相机远一点,否则无法看全棋盘格.
